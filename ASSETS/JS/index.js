...
let word = 'GenerationUSA'; // Default word if the fetch request fails.
let guessedLetters = [];
let remainingGuesses = 10; // Let's output this to screen
...
const updateGuessesRemaining = function (guess) {
  ...
  if (!letterArray.includes(guess)) {
    ...
    message.innerText = `Sorry, there is no ${guess} - try again!`;
    remainingGuesses -= 1;
  } else {
